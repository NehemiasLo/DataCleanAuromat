...
st.markdown("<p style='text-align: center; color: #6B7280; font-size: 0.9rem; margin: 1rem 0 0.5rem 0;'>¿No tienes un archivo a la mano para probar?</p>", unsafe_allow_html=True)
...
if df is not None:
    try:
        ...
        st.markdown("<p style='color:#6B7280; font-size:0.9rem; margin-bottom:1.5rem;'>El sistema ha analizado tu archivo y encontró los siguientes detalles estructurales:</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='color:#6B7280; font-size:0.95rem; margin-bottom:1.5rem;'>Elige qué operaciones automáticas deseas aplicar al dataset (están todas activadas por defecto para una limpieza óptima):</p>", unsafe_allow_html=True)
        ...
        if 'df_cleaned' in st.session_state:
            ...
            with tab_comparacion:
                ...
                with col_antes:
                    st.markdown("<p style='color: #EF4444; font-weight: 600;'>❌ Dataset Original (Con errores):</p>", unsafe_allow_html=True)
            ...
            with tab_detalles:
                st.markdown("<p style='color:#374151; font-weight: 500;'>Detalle de acciones tomadas de forma automática:</p>", unsafe_allow_html=True)
                if logs_finales:
                    for log in logs_finales:
                        st.markdown(f"<div style='color:#4B5563; font-size:0.95rem; margin-bottom:0.5rem; padding-left:0.75rem; border-left:3px solid #1E3A8A;'>{log}</div>", unsafe_allow_html=True)
                else:
                    st.markdown("<p style='color:#6B7280;'>No se requirieron modificaciones. El dataset cumple con todos los estándares de producción.</p>", unsafe_allow_html=True)
            ...
            with tab_visualizar:
                ...
                if not numerical_cols.empty or not categorical_cols.empty:
                    st.markdown("<p style='color:#6B7280; font-size:0.9rem; margin-bottom:1.5rem;'>Gráficos generados para entender las variables del archivo limpio:</p>", unsafe_allow_html=True)
                    ...
                    st.markdown("<p style='color:#6B7280;'>No hay columnas numéricas ni categóricas suficientes para estructurar visualizaciones.</p>", unsafe_allow_html=True)

            # --- Descarga directa del archivo pulido ---
            st.markdown("<hr>", unsafe_allow_html=True)
            st.markdown("<p style='text-align: center; color:#374151; font-weight: 500;'>¿Todo listo? Descarga tu archivo purificado aquí:</p>", unsafe_allow_html=True)
